...
| Kelompok Bahasan          | Substansi                                                                                                |
| ------------------------- | -------------------------------------------------------------------------------------------------------- |
| **Fondasi TTIS**          | Posisi, dasar regulasi, definisi, prinsip desain, dan model operasional TTIS.                            |
| **Model Operasional**     | Struktur organisasi, RACI, layanan, dokumen wajib, dan minimum viable TTIS.                              |
| **Proses Insiden**        | Siklus penanganan insiden, severity, pelaporan, eskalasi, dan koordinasi eksternal.                      |
| **Kapabilitas Pendukung** | Playbook, bukti digital, chain of custody, komunikasi insiden, TLP, KPI, dan pembelajaran berkelanjutan. |
...
| Kapabilitas Minimum         | Penjelasan                                                                                                              | Bukti Minimum                                                                |
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| **Mandat dan narahubung**   | Penunjukan resmi penanggung jawab TTIS, narahubung regulator/otoritas, dan call tree internal.                          | SK/nota penugasan, daftar kontak, dan jadwal piket/eskalasi.                 |
| **Prosedur pelaporan**      | Alur pelaporan internal dan eksternal untuk peristiwa dan insiden siber.                                                | SOP pelaporan, formulir insiden, dan matriks severity.                       |
| **RFC 2350/Profil TTIS**    | Profil layanan, ruang lingkup, jam layanan, kontak, dan mekanisme koordinasi.                                           | Dokumen RFC 2350/profil TTIS yang disetujui.                                 |
| **Playbook dasar**          | Prosedur minimum untuk skenario umum seperti ransomware, phishing, kebocoran data, gangguan layanan, dan kompromi akun. | Playbook prioritas dan hasil tabletop/walkthrough.                           |
| **Rekam insiden**           | Pencatatan kronologi, dampak, tindakan, bukti, status pemulihan, dan pembelajaran.                                      | Incident register, timeline, tiket, bukti digital, dan post-incident review. |
| **Koordinasi pihak ketiga** | Mekanisme eskalasi ke vendor core system, cloud, jaringan, SOC, atau penyedia layanan kritikal.                         | Daftar kontak vendor, SLA, klausul insiden, dan hasil uji eskalasi.          |
...
| Level Kapabilitas TTIS | Karakteristik                                                                                                                                          | Contoh Bukti                                                                                    |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------- |
| **Minimum**            | Memiliki kontak resmi, SK tim, prosedur pelaporan, RFC 2350/profil TTIS, playbook dasar, dan rekam insiden.                                            | SK, call tree, SOP, formulir insiden, RFC 2350, dan incident register.                          |
| **Intermediate**       | Monitoring terstruktur, severity matrix, tabletop exercise, koordinasi regulator, pengelolaan bukti digital, dan post-incident review.                 | Dashboard monitoring, hasil tabletop, laporan insiden, chain of custody, dan tracker remediasi. |
| **Advanced**           | 24/7 monitoring atau mekanisme setara berbasis risiko, threat intelligence, otomasi triage, forensik awal, crisis communication, dan pemulihan teruji. | Use case SIEM, intel report, hasil drill, komunikasi krisis, dan hasil uji restore.             |
| **Leading**            | CTI sharing, purple team, SOAR, metric-driven improvement, integrasi risiko enterprise, dan pembelajaran lintas ekosistem.                             | Laporan CTI, hasil purple team, SOAR workflow, tren KPI/KRI, dan lesson learned terintegrasi.   |
...
| Area            | Implikasi                                                                                                                                                 |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Organisasi**  | TTIS perlu memiliki mandat, struktur, peran, layanan, dokumen, dan narahubung yang jelas.                                                                 |
| **Operasional** | Setiap peristiwa dan insiden siber perlu dikelola melalui alur deteksi, triage, eskalasi, containment, eradikasi, pemulihan, pelaporan, dan pembelajaran. |
| **Koordinasi**  | Pelaporan kepada regulator, BSSN/TTIS nasional atau sektoral, pihak terdampak, dan publik harus menggunakan rekam insiden utama yang konsisten.           |
| **Pengukuran**  | Kapabilitas TTIS perlu diukur melalui KPI/KRI seperti MTTD, MTTC, MTTR, ketepatan pelaporan, pengujian playbook, dan penyelesaian remediasi.              |
