...
{% hint style="info" %}
Bab VI berfokus pada kapabilitas operasional TTIS sebagai fungsi respons insiden. Materi pelaporan kematangan KKS dibahas pada Bab IV, sedangkan Bab ini membahas pengelolaan peristiwa dan insiden siber mulai dari deteksi, triage, eskalasi, penanggulangan, pemulihan, pelaporan insiden, pengelolaan bukti digital, komunikasi, hingga pembelajaran pascainsiden.
{% endhint %}

<table><thead><tr><th>Kelompok Bahasan</th><th>Substansi</th></tr></thead><tbody><tr><td><strong>Fondasi TTIS</strong></td><td>Posisi, dasar regulasi, definisi, prinsip desain, dan model operasional TTIS.</td></tr><tr><td><strong>Model Operasional</strong></td><td>Struktur organisasi, RACI, layanan, dokumen wajib, dan minimum viable TTIS.</td></tr><tr><td><strong>Proses Insiden</strong></td><td>Siklus penanganan insiden, severity, pelaporan, eskalasi, dan koordinasi eksternal.</td></tr><tr><td><strong>Kapabilitas Pendukung</strong></td><td>Playbook, bukti digital, chain of custody, komunikasi insiden, TLP, KPI, dan pembelajaran berkelanjutan.</td></tr></tbody></table>
...
### **Rekomendasi Model Berdasarkan Ketersediaan Sumber Daya**

<table><thead><tr><th valign="top">Kondisi Sumber Daya</th><th valign="top">Ciri Organisasi</th><th valign="top">Model yang Disarankan</th><th valign="top">Kapabilitas Minimum yang Harus Ada</th></tr></thead><tbody><tr><td valign="top"><strong>Sumber Daya Terbatas</strong></td><td valign="top">Tim TI kecil, belum memiliki SOC, belum memiliki analis forensik, bergantung pada vendor, dan insiden dikelola secara ad hoc.</td><td valign="top"><strong>Managed/Co-sourced</strong> dengan koordinator internal; atau <strong>Terpusat sederhana</strong>.</td><td valign="top">Incident coordinator, daftar kontak eskalasi, prosedur pelaporan, kontrak dukungan insiden, backup-restore, evidence preservation, dan tabletop exercise dasar.</td></tr><tr><td valign="top"><strong>Sumber Daya Menengah</strong></td><td valign="top">Memiliki fungsi keamanan TI, monitoring terbatas, beberapa spesialis teknis, prosedur insiden dasar, dan dukungan vendor untuk area tertentu.</td><td valign="top"><strong>Terpusat</strong> atau <strong>Hybrid SOC-CSIRT</strong> dengan managed SOC/DFIR.</td><td valign="top">TTIS formal, playbook insiden utama, severity matrix, log management, vulnerability handling, forensik dasar, crisis communication, dan post-incident review.</td></tr><tr><td valign="top"><strong>Sumber Daya Mapan</strong></td><td valign="top">Memiliki SOC, CISO/Head of Cybersecurity, tim keamanan aplikasi/infrastruktur, incident commander, risk-compliance support, dan anggaran keamanan siber berkelanjutan.</td><td valign="top"><strong>Hybrid SOC-CSIRT</strong> sebagai model utama; <strong>Federated</strong> apabila organisasi multi-unit.</td><td valign="top">SOC 24/7, SIEM, threat intelligence, incident command, forensic readiness, playbook teruji, crisis management, vendor assurance, dan recovery exercise.</td></tr><tr><td valign="top"><strong>Sumber Daya Lanjut</strong></td><td valign="top">Memiliki SOC 24/7 matang, CTI, DFIR, red/purple team, automation, security engineering, BCM kuat, dan integrasi cyber-fraud-risk.</td><td valign="top"><strong>Federated Hybrid SOC-CSIRT</strong> dengan orchestration dan continuous improvement.</td><td valign="top">SOAR, automated containment, threat hunting, purple teaming, continuous control monitoring, joint exercise dengan vendor/regulator, dan pembelajaran pascainsiden terintegrasi.</td></tr></tbody></table>
...
### Minimum Viable TTIS untuk Organisasi dengan Sumber Daya Terbatas

Organisasi dengan skala kecil, sumber daya terbatas, atau ketergantungan tinggi pada penyedia jasa TI tetap perlu memiliki fungsi TTIS minimum. Fungsi ini tidak harus berbentuk unit besar, tetapi harus memiliki mandat, narahubung, prosedur, daftar layanan kritikal, alur eskalasi, dan mekanisme koordinasi yang dapat berjalan saat terjadi insiden.

<table><thead><tr><th>Kapabilitas Minimum</th><th>Penjelasan</th><th>Bukti Minimum</th></tr></thead><tbody><tr><td><strong>Mandat dan narahubung</strong></td><td>Penunjukan resmi penanggung jawab TTIS, narahubung regulator/otoritas, dan call tree internal.</td><td>SK/nota penugasan, daftar kontak, dan jadwal piket/eskalasi.</td></tr><tr><td><strong>Prosedur pelaporan</strong></td><td>Alur pelaporan internal dan eksternal untuk peristiwa dan insiden siber.</td><td>SOP pelaporan, formulir insiden, dan matriks severity.</td></tr><tr><td><strong>RFC 2350/Profil TTIS</strong></td><td>Profil layanan, ruang lingkup, jam layanan, kontak, dan mekanisme koordinasi.</td><td>Dokumen RFC 2350/profil TTIS yang disetujui.</td></tr><tr><td><strong>Playbook dasar</strong></td><td>Prosedur minimum untuk skenario umum seperti ransomware, phishing, kebocoran data, gangguan layanan, dan kompromi akun.</td><td>Playbook prioritas dan hasil tabletop/walkthrough.</td></tr><tr><td><strong>Rekam insiden</strong></td><td>Pencatatan kronologi, dampak, tindakan, bukti, status pemulihan, dan pembelajaran.</td><td>Incident register, timeline, tiket, bukti digital, dan post-incident review.</td></tr><tr><td><strong>Koordinasi pihak ketiga</strong></td><td>Mekanisme eskalasi ke vendor core system, cloud, jaringan, SOC, atau penyedia layanan kritikal.</td><td>Daftar kontak vendor, SLA, klausul insiden, dan hasil uji eskalasi.</td></tr></tbody></table>

{% hint style="success" %}
Minimum viable TTIS membantu organisasi memulai dari kapabilitas yang realistis tanpa mengabaikan kebutuhan dasar respons insiden. Kapabilitas ini perlu ditingkatkan bertahap sejalan dengan hasil IKAS, profil risiko, dan kompleksitas layanan digital.
{% endhint %}
...
{% step %}
### 6.10.4 Eskalasi dan Koordinasi
...
Insiden siber yang berkaitan dengan data pribadi perlu dikelola secara lintas fungsi. TTIS/SOC bertanggung jawab atas analisis teknis dan containment; fungsi hukum memastikan pemenuhan kewajiban hukum; fungsi pelindungan data pribadi memastikan penilaian dampak terhadap subjek data; fungsi kepatuhan menyelaraskan kewajiban pelaporan regulator; fungsi komunikasi dan layanan nasabah menyiapkan pesan resmi, FAQ, serta kanal bantuan; sedangkan manajemen risiko memastikan risiko residual dan rencana perbaikan tercatat.
...
Berikut adalah tabel kelompok dan contoh bukti digital yang umum ada pada insiden di sektor keuangan, serta perlakuan minimum yang perlu diperhatikan organisasi. Perlakuan minimum seperti akuisisi barang bukti digital membutuhkan keterampilan dan keahlian khusus, sehingga organisasi perlu mengalokasikan sumber daya untuk SDM nya agar dapat dilatih dan/atau disertifikasi, sehingga bukti digital dapat dijamin keabsahannya sejak awal.
...
{% hint style="danger" %}
**Aturan dasar:** jangan melakukan perubahan pada sistem terdampak sebelum bukti kritikal diamankan, kecuali tindakan segera yang diperlukan untuk mencegah dampak yang lebih besar. Setiap tindakan darurat harus dicatat dalam linimasa insiden.
{% endhint %}
...
### Kapabilitas TTIS Berdasarkan Tingkat Kematangan

<table><thead><tr><th>Level Kapabilitas TTIS</th><th>Karakteristik</th><th>Contoh Bukti</th></tr></thead><tbody><tr><td><strong>Minimum</strong></td><td>Memiliki kontak resmi, SK tim, prosedur pelaporan, RFC 2350/profil TTIS, playbook dasar, dan rekam insiden.</td><td>SK, call tree, SOP, formulir insiden, RFC 2350, dan incident register.</td></tr><tr><td><strong>Intermediate</strong></td><td>Monitoring terstruktur, severity matrix, tabletop exercise, koordinasi regulator, pengelolaan bukti digital, dan post-incident review.</td><td>Dashboard monitoring, hasil tabletop, laporan insiden, chain of custody, dan tracker remediasi.</td></tr><tr><td><strong>Advanced</strong></td><td>24/7 monitoring atau mekanisme setara berbasis risiko, threat intelligence, otomasi triage, forensik awal, crisis communication, dan pemulihan teruji.</td><td>Use case SIEM, intel report, hasil drill, komunikasi krisis, dan hasil uji restore.</td></tr><tr><td><strong>Leading</strong></td><td>CTI sharing, purple team, SOAR, metric-driven improvement, integrasi risiko enterprise, dan pembelajaran lintas ekosistem.</td><td>Laporan CTI, hasil purple team, SOAR workflow, tren KPI/KRI, dan lesson learned terintegrasi.</td></tr></tbody></table>
...
<table><thead><tr><th>Area</th><th>Implikasi</th></tr></thead><tbody><tr><td><strong>Organisasi</strong></td><td>TTIS perlu memiliki mandat, struktur, peran, layanan, dokumen, dan narahubung yang jelas.</td></tr><tr><td><strong>Operasional</strong></td><td>Setiap peristiwa dan insiden siber perlu dikelola melalui alur deteksi, triage, eskalasi, containment, eradikasi, pemulihan, pelaporan, dan pembelajaran.</td></tr><tr><td><strong>Koordinasi</strong></td><td>Pelaporan kepada regulator, BSSN/TTIS nasional atau sektoral, pihak terdampak, dan publik harus menggunakan rekam insiden utama yang konsisten.</td></tr><tr><td><strong>Pengukuran</strong></td><td>Kapabilitas TTIS perlu diukur melalui KPI/KRI seperti MTTD, MTTC, MTTR, ketepatan pelaporan, pengujian playbook, dan penyelesaian remediasi.</td></tr></tbody></table>
